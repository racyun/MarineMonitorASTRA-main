...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--train_path', default='satellite_amd/images.csv', type=str,
                        help='Train .csv path')
    parser.add_argument('--train_path2', default='satellite_amd/images2.csv', type=str,
                        help='Train .csv path')
...
def main(args):
    ...
    args['--train_path'] = args['--train_path2']
    dataset_train2 = build_fmow_dataset(is_train=True, args=args)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.model_type == 'temporal':
            ...
            train_stats = train_one_epoch(
                model, data_loader_train, data_loader_train2,
                optimizer, device, epoch, loss_scaler,
                log_writer=log_writer,
                args=args
            )
