...
def train_one_epoch(model: torch.nn.Module,
                    data_loader: Iterable, data_loader2: Iterable, optimizer: torch.optim.Optimizer,
    ...
    for data_iter_step, ((samples, _), (samples2, _)) in enumerate(metric_logger.log_every(zip(data_loader, data_loader2), print_freq, header)):
        ...
        with torch.cuda.amp.autocast():
            loss, _, _ = model(samples, samples2, mask_ratio=args.mask_ratio)
